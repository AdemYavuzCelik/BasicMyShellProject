...
while(1){
   ...
   char *komutlar[sayac];
	...
	//burda dizi elemaný gönderdiðimiz için pass by reference oluyor ve komutlar dizisi bozuluyor bu yüzden fonksiyonda gelen stringi bir baþka stringte tutmalýyým.
	for(i=0; i<sayac; i++){
